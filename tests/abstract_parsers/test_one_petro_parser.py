...
############################### Change these... ##########################################
#                                               also this                   and this
from abstract_retriever.abstract_parsers.one_petro_parser import OnePetroParser
example_class = OnePetroParser
example_url = "https://onepetro.org/"
example_doi = "10.5957/SOME-2023-033"
example_abstracts_start = "Current maintenance procedures for ship hulls are based around"
##########################################################################################
